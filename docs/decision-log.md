...
**Chosen:** Two named options — "Coming up soon" (filters to future-dated assets only, sorted ascending by executionDate) and "New to the library" (lastModifiedDate descending)
